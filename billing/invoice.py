...
def generate_and_send_invoices(biweek_start: date, biweek_end: date):
    ...
    with Progress() as progress:
        ...
        # Send invoices
        if(get_valid_yes_no("Would you like to email out the invoices? (y/n): ")):
