...
import P5VizWrapper from "./P5VizWrapper";
import { useAppStore } from "@/store/app";

const HomePageLogoSketch = () => {
	type Vec = {
		x: number;
		y: number;
	};
	...
	return <P5VizWrapper title="" key={`propel-canvas-${canvasWidth}`} setup={setup} draw={draw} />;
};

export default HomePageLogoSketch;
